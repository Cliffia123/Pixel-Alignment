...
def get_args():
    ...
    parser.add_argument('--cls_checkpoint', default='', type=str, metavar='PATH',
                        help='path to latest checkpoint (default: none)')
    ...
    parser.add_argument('--pretrained', type=str2bool, nargs='?',
                        const=True, default=True, help='use pre-trained model')
    ...
    parser.add_argument('--bbox-mode', type=str, default='classical',
                        help="Method for bbox generation")
    parser.add_argument('--model', default='gcn', type=str, metavar='NETWORK',
                        help='Network to train')

    parser.add_argument('--crf_fc', default=False, type=str2bool)
    parser.add_argument('--crf_lambda', default=2.e-9)
    parser.add_argument('--crf_sigma_rgb', default=15.)
    parser.add_argument('--crf_sigma_xy', default=100.)
    parser.add_argument('--crf_scale_factor',default=1)

    #sim
    parser.add_argument('--sim_fg_thres', type=float, default=0.6, help='foreground threshold value')
    parser.add_argument('--sim_bg_thres', type=float, default=0.1, help='background threshold value')

    #change 2021.12.26
    parser.add_argument('----training_cls', default=True, type=str2bool)

    #LayerCam
    parser.add_argument("--img_path", type=str, default='images/ILSVRC2012_val_00000476.JPEG',
                        help='Path of test image')
    parser.add_argument("--layer_id", type=list, default=[16, 23, 30], help='The cam generation layer')
